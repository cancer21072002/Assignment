    ...
    item.quantity
                        ...
                        ${item.price}
                            ...
                            <td class="text-right">
                                                    <button data-id="${
    item.id
}" class="bg-green-500 text-white btn btn-increase mr-2 px-2">Tăng</button>
                                <button data-id="${
    item.id
}" class="bg-orange-500 text-white btn btn-decrease mr-2 px-2">Giảm</button>
                                    <button data-id="${
    item.id
}" class="bg-[red] text-white btn btn-remove mr-2 px-2">Xóa</button>
