        ...
        return /* html */ `
          ...
          <svg class="hidden h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
              ...
              <img class="h-8 w-8 rounded-full" src="https://scontent.fhan2-4.fna.fbcdn.net/v/t1.6435-9/131098426_1046000512571211_7071186751933183951_n.jpg?_nc_cat=103&ccb=1-5&_nc_sid=174925&_nc_ohc=m1WWdEsjR1sAX_EpRac&_nc_ht=scontent.fhan2-4.fna&oh=00_AT_t7QMEq0sNMHyzRNKnVmLOS84e8QK7LNGw_NuL-1tDKw&oe=62398E65" alt="">
            </button>
                        </div>
